...
//{B600D26B-F464-4308-8AC7-043969B7614A}
const CLSID CLSID_FSMFactory = {0x29106A92,0x9342,0x4F4E,{0xA7,0x89,0xE4,0x20,0x21,0x91,0x78,0x1C}};
...
{
    public:
        virtual HRESULT __stdcall CreateInstanceWPar(const IID& iid, void** ppv, int a) = 0;
};
...
class IFileManager: public IUnknown
{
	public:
		...
		virtual HRESULT __stdcall DeleteFile(char *path)=0;
};
